 ...
 * @e_ident: This will be a pointer to an array containing the ELF magic numbers.
 *
...
/**
 * print_data - This comment prints the data of an ELF header.
 * @e_ident: This shows a pointer to an array containing the ELF class.
 */
void print_data(unsigned char *e_ident)
{
	printf("  Data:                              ");
 ...
 * @e_ident: This is for a pointer to an array containing the ELF class.
 */
void print_type(unsigned int e_type, unsigned char *e_ident)
{
 ...
 * @e_ident: This points as a  pointer to an array containing the ELF class.
 */
void print_entry(unsigned long int e_entry, unsigned char *e_ident)
{
 ...
 * @argc: This displays the number of arguments supplied to the program.
